...
status = robotic_function.robot_rotate(port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION, pos2,6,0.9,-0.6,1.4,-80,0,1);
status = robotic_function.robot_rotate(port_num, PROTOCOL_VERSION, ADDR_PRO_GOAL_POSITION, pos3,2.5,0.6,0.3,0.5,-80,0,2);
